...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    fetch(jsonUrl).then(res => res.json()).then(data => {
        ...
        // FRONT PAGE MODE: Individual white clippings on the grey background
        if (summaryContainer) {
            ...
            filteredData.forEach(item => {
                ...
                summaryContainer.innerHTML += `
                    <div class="news-clipping" style="background: #ffffff; padding: 25px; margin-bottom: 30px; border: 1px solid #bbb; box-shadow: 6px 6px 0px rgba(0,0,0,0.1); font-family: 'Times New Roman', serif; text-align: left;">
        ...
        // HUB PAGE MODE: Full articles (already working)
        if (fullContainer) {
